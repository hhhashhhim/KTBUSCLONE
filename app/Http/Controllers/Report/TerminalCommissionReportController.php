...
class TerminalCommissionReportController extends Controller
{
    ...
    {return 'helo';
        return $tickets = Ticket::with('updated_name:id,name', 'ticketElt:id,ticket_id,elt_price', 'terminal:id,name', 'busClass:id,name', 'schedule:id,name,time',"bus:id,bus_number")
            ...
            ->whereBetween('schedule_time_exact', ["12:00:00", "13:00:00"])
            ->orderBy('date', 'desc')
            ->get();
