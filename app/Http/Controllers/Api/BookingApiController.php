...
class BookingApiController extends Controller
{
    ...
    public function availableSchedules(Request $request)
    {
        ...
        try {
                ...
                ->with("departure_city:id,name","destination_city:id,name","bus_class:id,name,font_icons","bus_class_map:id,name,seat_map")
    ...
    public function previewSchedule(Request $request)
    {
        try {
                ...
                $scheduleDetail = ScheduleDetail::with("bus_class:id,font_icons,seat_map")->where([
                    'company_id' => $companyId,
                ...
                try {
                    ...
                    // } else {
                        ...
                        foreach($checkAlreadyBooked as $tkt)
                        {
                            ...
                            if(($ticketDepIndex >= $scheduleDepIndex && $ticketDepIndex < $scheduleDesIndex)
                            ...
                            if(($scheduleDepIndex >= $ticketDepIndex && $scheduleDepIndex < $ticketDesIndex)
