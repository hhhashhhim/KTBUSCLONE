...
class AllBookingController extends Controller
{
    ...
    public function filter(Request $request)
    {
        ...
        return $data->with("schedule:id,route_id", "schedule.route:id,name", "bus:id,bus_number", "terminal:id,name", "addedBy:id,name", "scheduleDetail:id,departure_time", "cancel:id,ticket_id,added_by,created_at", "cancel.addedBy:id,name")->select("tickets.*", "customers.name", "customers.cnic", "customers.contact")->get();
    }
}
