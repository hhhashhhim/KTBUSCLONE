...
<div id="info">
    ...
    <div class="custinfo" id="custinfo">
        ...
        <div>
            <p class="font-weight-bold float-left">From : &nbsp; <span>{{$data[$key]['departure_city']->name}}</span>
            </p>
            <p class="font-weight-bold float-right">To : &nbsp; <span>{{ $data[$key]['destination_city']->name }}</span>
            </p>
        </div>
        <div class="clear-both">
...
<div class="custinfoverify" id="custinfoverify">
    ...
    <div style="width:100%">
        <p style="margin-bottom: 0" class="font-weight-bold float-left">Seat # :
            &nbsp;<span>{{ $data[$key]->seat_no }}</span></p>
        <p style="margin-bottom: 0" class="font-weight-bold float-right">Bus No : &nbsp;<span>Bus#&nbsp;&nbsp; </span>
        </p>
    </div>
