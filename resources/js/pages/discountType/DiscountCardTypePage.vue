                ...
                <div class="col-12 col-md-12 col-lg-12">
                    <div class="card card-primary">
                        <div class="card-header d-flex justify-content-between">
                            <h4>Discount Card Type</h4>
                            <div class="card-header-action">
                                <a v-if="checkForSubmenuButtons('add-card-discount')"
                                    href="#"
                                    data-toggle="modal"
                                    :data-target="'#' + formID"
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>Added By</th>
                                                        <th v-if="checkForSubmenuButtons('edit-card-discount')">Action</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr v-for="(card, i) in cards" :key="i">
                                                        ...
                                                        <td v-if="checkForSubmenuButtons('edit-card-discount')">
                                                            <button v-if="checkForSubmenuButtons('edit-card-discount')" :data-target="'#' + editFormID" data-toggle="modal"
                                                                    @click="edit(card)"
            ...
            >
                ...
                <template v-slot:button>
                    <button type="button" class="btn btn-primary" @click="storeCardDetails" :disabled="loading">
                        {{ loading ? 'Loading...' : 'Save Card Type' }}
                    </button>
                </template>
            </Add>
            ...
            >
                ...
                <template v-slot:button>
                    <button type="button" class="btn btn-primary" @click="updateCard()"
                            :disabled="loading"> {{ loading ? 'Loading...' : 'Update Card Type' }}
                    </button>
                </template>
            </Edit>
            <!--            Edit MOdel End-->
...
export default {
    ...
    data() {
        return {
            ...
            formID: "card_type",
            editFormID: "edit_card_type",
            deleteFormID: "delete_card_type",
            validationErrors: [],
            success: false,
            error: false,
            CardName: '',
    ...
    methods: {
        ...
        async fetchCardCategories() {
            const res = await this.callApi("post", 'discountCard');
            if (res.status == 200) {
                this.cards = res.data
            } else {
                console.log(res);
        ...
        async storeCardDetails() {
            ...
            const resCard = await this.callApi("post", "discountCard/store", data);
        ...
        async updateCard() {
            ...
            this.loading = true;
            const resUpdateCard = await this.callApi("post", 'discountCard/update', this.dataEdit);
