<template>
          ...
          <div class="card card-primary">
            <div class="card-header">
              ...
              <div class="card-header-action">
                <a
                  v-if="checkForSubmenuButtons('add-terminal')"
                  href="#add-modal"
                  data-toggle="modal"
                  :data-target="'#' + formID"
                    ...
                    >
                      <thead>
                        <tr>
                          ...
                          <th
                            v-if="
                              checkForSubmenuButtons('view-terminal') ||
                              checkForSubmenuButtons('edit-terminal') ||
                              checkForSubmenuButtons('delete-terminal') ||
                              checkForSubmenuButtons('commission') ||
                              checkForSubmenuButtons('discount')
                            "
                          >
                            Action
                          </th>
      ...
      >
        <div class="row">
          <div class="form-group col-md-4">
            <label for="city_id"
              >Terminal City <span class="text-danger ml-1">*</span></label
            >
          ...
          <div class="form-group col-md-4">
            <label for="name"
              >Terminal Name <span class="text-danger ml-1">*</span></label
            >
            <input
              type="text"
              class="form-control"
          ...
          <div class="form-group col-md-4">
            <label for="name"
              >Terminal Name In Urdu<span class="text-danger ml-1"
                >*</span
              ></label
            >
            <input
        ...
        <div class="row">
          <div
            class="form-group mt-4 pt-3"
            :class="
              !this.showDivComma && !this.showDivDash ? 'col-md-6' : 'col-md-5'
            "
          >
          ...
          <div
            class="form-group"
            :class="
              !this.showDivComma && !this.showDivDash ? 'col-md-6' : 'col-md-3'
            "
          >
            <label for="contact"
              >Terminal Contact <span class="text-danger ml-1">*</span>
            </label>
            <vue-mask
              class="form-control"
        ...
        <div class="row">
          <div class="form-group col-md-12">
            <label for="address"
              >Address <span class="text-danger ml-2">*</span></label
            >
            <textarea
              class="form-control"
              spellcheck="false"
              ...
              maxlength="140"
              placeholder="Address Must be less then 140 characters or 21 words"
            ></textarea>
          </div>
  ...
  <div class="d-block">
    <input type="checkbox" value="confirm" v-model="sendMessageArray" id="createConfirmBooking" />
    <label for="createConfirmBooking" class="mx-1">Confirm Booking</label>
  </div>

  <div class="d-block">
    <input type="checkbox" value="reserved" v-model="sendMessageArray" id="createReservedBooking" />
    <label for="createReservedBooking" class="mx-1">Reserved Booking</label>
  </div>
</div>
        ...
        <div class="row">
          <div class="form-group col-md-3">
            ...
            <input
              ...
              v-model="data.reservation_cancel"
              placeholder=""
            />
          </div>
          <div class="form-group col-md-3">
            ...
            <input
              ...
              placeholder="Enter Advance Booking Allowed"
            />
          </div>
          <div class="form-group col-md-3">
      ...
      >
        <div class="row">
          ...
          <div class="form-group col-md-4">
            <label for="name"
              >Terminal Name In Urdu
              <span class="text-danger ml-1">*</span></label
            >
            <input
              type="text"
              class="form-control"
              v-model="dataEdit.urdu_name"
              dir="rtl"
            />
          </div>
        </div>
        <div class="row">
          ...
          <div
            ...
            v-if="dataEdit.allowed_type == 'comma'"
          >
            <label for="available_seats">Allowed Seats</label>
            <vue-mask
              class="form-control"
          ...
          <div
            class="form-group col-md-4"
            v-if="dataEdit.allowed_type == 'dash'"
          >
            <label for="available_seats">Allowed Seats</label>
            <vue-mask
              class="form-control"
          ...
          <div
            class="form-group"
            :class="dataEdit.allowed_type == 'all' ? 'col-md-6' : 'col-md-3'"
          >
            <label for="contact"
              >Terminal Contact <span class="text-danger ml-1">*</span>
            </label>
          ...
          <div class="form-group col-md-3">
            ...
            <div class="d-flex gap-3">
              <div class="form-check">
                ...
                />
                <label class="form-check-label" for="cash1"> Cash </label>
              </div>
              ...
              <div class="form-check">
                <input
                  ...
                  v-model="dataEdit.recovery_method"
                />
                <label class="form-check-label" for="bank1"> Bank </label>
              </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="form-group col-md-3">
            ...
            <input
              ...
              class="form-control"
              @keypress="isNumber($event)"
              v-model="dataEdit.reservation_cancel"
              placeholder=""
            />
          </div>
          <div class="form-group col-md-3">
          ...
          <div class="form-group col-md-4">
            <label for="phoneNumber"
              >Show other terminal passenger detail</label
            >
            <div class="d-block">
              <input
                type="checkbox"
                v-model="dataEdit.other_terminal_passenger_detail"
              />
  ...
  <input
    type="checkbox"
    value="confirm"
    v-model="dataEdit.send_message"
    id="confirmBooking"
  />
  <label for="confirmBooking" class="mx-1">
    Confirm Booking
  </label>
</div>
...
<div class="d-block">
  <input
    ...
    id="reservedBooking"
  />
  <label for="reservedBooking" class="mx-1">
    Reserved Booking
  </label>
</div>
                    ...
                    >
                      ...
                      <tbody>
                        <tr v-for="(single, i) in terminalsDetails" :key="i">
                          ...
                          <td v-else>N/A</td>
                          <td v-if="single.recovery_method">
                            {{ single.recovery_method }}
                          </td>
                          <td v-else>N/A</td>
                          <td v-if="single.address">{{ single.address }}</td>
                          <td v-else>N/A</td>
                          <td v-if="single.contact">
                            {{ phoneFormat(single.contact) }}
                          </td>
                          <td v-else>N/A</td>
...
export default {
  ...
  async add() {
  // Validation
  if (!this.data.city_id) return swal({ title: "Required", text: "Terminal City is required", icon: "error", timer: 2000 });
  if (!this.data.name) return swal({ title: "Required", text: "Terminal Name is required", icon: "error", timer: 2000 });
  if (!this.data.urdu_name) return swal({ title: "Required", text: "Terminal Urdu Name is required", icon: "error", timer: 2000 });
  if (!this.data.contact) return swal({ title: "Required", text: "Terminal Contact is required", icon: "error", timer: 2000 });
  if (!this.data.address) return swal({ title: "Required", text: "Terminal Address is Required", icon: "error", timer: 2000 });

  // Map checkbox array to numeric send_message
  const arr = this.sendMessageArray || [];
  if (arr.includes("confirm") && arr.includes("reserved")) {
    this.data.send_message = 3;
  } else if (arr.includes("confirm")) {
    this.data.send_message = 1;
  } else if (arr.includes("reserved")) {
    this.data.send_message = 2;
  } else {
    this.data.send_message = 0;
  }

  // Ensure numeric value
  this.data.send_message = Number(this.data.send_message);
  ...
  try {
    ...
    if (res.status == 200) {
      swal({ title: "Success", text: "Terminal Created Successfully", icon: "success", timer: 2000 });
      this.loading = false;
      ...
      if (res.status === 422) {
        for (const key in res.data.errors) {
          res.data.errors[key].forEach((element) => this.errorsArray(element, key));
        }
      }
      if (res.status === 423) {
    ...
    swal({ title: "Error", text: "Something went wrong while creating terminal.", icon: "error", timer: 2000 });
  }
},

    async editTerminal(single) {
      this.dataEdit = single;
      this.dataEdit.other_terminal_passenger_detail =
        single.other_terminal_passenger_detail == 1 ? true : false;
      this.dataEdit.send_message =
  single.send_message == 1
    ? ["confirm"]
    : single.send_message == 2
    ? ["reserved"]
    : single.send_message == 3
    ? ["confirm", "reserved"]
    : [];
    ...
    async update() {
      ...
      if (
        ...
        typeof this.dataEdit.address == "undefined"
      )
        return swal({
          title: "Required",
    ...
    async hideTerminal() {
      this.loading = true;
      const resHide = await this.callApi("post", "terminals/hide", {
        id: this.delId,
      });
  ...
  watch: {
  sendMessageArray(newVal) {
    if (newVal.length === 0) this.data.send_message = 0;      // none
    else if (newVal.length === 1 && newVal[0] === "confirm") this.data.send_message = 1;
    else if (newVal.length === 1 && newVal[0] === "reserved") this.data.send_message = 2;
    else if (newVal.length === 2) this.data.send_message = 3;  // both
  }
}
