          ...
          <div class="col-12">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="">
                  <div class="card">
                    <div class="card-body d-flex justify-content-around flex-wrap py-3">
                      <div class="tab-option text-center p-2"
                        :class="{ active: currentTab === 'inventoryControlRegister' }"
                        @click="currentTab = 'inventoryControlRegister'">
                        <span>1. Inventory Control Register</span>
                      </div>

                      <div class="tab-option text-center p-2"
                        :class="{ active: currentTab === 'inventoryGoodReceived' }"
                        @click="currentTab = 'inventoryGoodReceived'">
                        <span>2. Inventory Good Received</span>
                      </div>

                      <div class="tab-option text-center p-2" :class="{ active: currentTab === 'inventoryGoodIssued' }"
                        @click="currentTab = 'inventoryGoodIssued'">
                        <span>3. Inventory Good Issued</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="table-responsive card px-3 py-2" v-if="currentTab === 'inventoryGoodReceived'">
                  ...
                  <div class="row">
                    <div class="col-md-2">
                      <label>GRN #</label>
                      <input type="number" class="form-control" v-model.number="filters.grn"
                        placeholder="Enter GRN Number">
                    </div>
                    <div class="col-md-2">
                      <label>PO #</label>
                      <input type="number" class="form-control" v-model.number="filters.po"
                ...
                <div class="table-responsive card px-3 py-2" v-if="currentTab === 'inventoryGoodIssued'">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <label>Bus</label>
                      <select v-model="filters.bus_id" class="form-control">
  ...
  methods: {
    ...
    async applyIssuedFilters() {
      const payload = {
        ...
        product_id: this.filters.product_id || null,
        bus_id: this.filters.bus_id || null,
        from_date: this.filters.from_date || null,
        to_date: this.filters.to_date || null,
      };
