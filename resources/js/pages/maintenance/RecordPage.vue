<template>
    <section class="section">
        <div class="section-body">
            ...
            <Edit
                :heading="'Due Maintenance Update'"
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <a
                    :href="($store.state.app_url +'uploads/maintenance/'+ postData.evidence)"
                    target="_blank"
                    >
                        <img
                            :src="($store.state.app_url +'uploads/maintenance/'+ postData.evidence)"
            ...
            <template v-slot:button>
                <button type="button" class="btn btn-primary"  @click="dueMaintenanceUpdate" :disabled="loading" >{{loading ? 'Loading...' : 'Update' }}
                </button>
            </template>
            </Edit>
        </div>
