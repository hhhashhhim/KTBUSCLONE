                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="terminalsFilter" class="form-control"
                                                            v-model="filterForm.terminalFilter" @change="filterFunction()">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="date" class="form-control" id="dateFilter"
                                                            v-model="filterForm.dateFilter" @change="filterFunction()">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select id="statusFilter" class="form-control"
                                                            v-model="filterForm.statusFilter" @change="filterFunction()">
                                                        ...
                                                        <tbody>
                                                            <tr v-for="(record, i) in allRecords" :key="i">
                                                                ...
                                                                <td v-if="record.schedule_detail">{{
                                                                    record.schedule_detail.departure_time }} </td>
                                                                <td v-else>N/A</td>
                                                                ...
                                                                <td>{{ parseFloat(record.seat_fare) -
                                                                    parseFloat(record.discount ?? 0) }} </td>
