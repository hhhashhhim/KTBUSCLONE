<template>
    <!--Admin Dashboard-->
    <div v-if="$store.state.user.is_super_admin == 1">
                                ...
                                <table class="table table-striped">
                                        ...
                                        <td class="text-truncate">
                                            <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                            :src="$store.state.app_url + 'assets/img/users/user-8.png'"
                                                                                            alt="user"
                                                                                            data-toggle="tooltip"
                                                                                            title=""
                                                ...
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                            :src="$store.state.app_url + 'assets/img/users/user-9.png'"
                                                                                            alt="user"
                                                                                            data-toggle="tooltip"
                                                                                            title=""
                                                ...
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                            :src="$store.state.app_url + 'assets/img/users/user-10.png'"
                                                                                            alt="user"
                                                                                            data-toggle="tooltip"
                                                                                            title=""
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate">
                                            <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                            :src="$store.state.app_url + 'assets/img/users/user-1.png'"
                                                                                            alt="user"
                                                                                            data-toggle="tooltip"
                                                                                            title=""
                                                                                            data-original-title="Wildan Ahdian">
                                                ...
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                            :src="$store.state.app_url + 'assets/img/users/user-2.png'"
                                                                                            alt="user"
                                                                                            data-toggle="tooltip"
                                                                                            title=""
                                                                                            data-original-title="John Deo">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate">
                                            <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                            :src="$store.state.app_url + 'assets/img/users/user-3.png'"
                                                                                            alt="user"
                                                                                            data-toggle="tooltip"
                                                                                            title=""
                                                                                            data-original-title="Wildan Ahdian">
                                                ...
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                            :src="$store.state.app_url + 'assets/img/users/user-4.png'"
                                                                                            alt="user"
                                                                                            data-toggle="tooltip"
                                                                                            title=""
                                                                                            data-original-title="John Deo">
                                                ...
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                            :src="$store.state.app_url + 'assets/img/users/user-5.png'"
                                                                                            alt="user"
                                                                                            data-toggle="tooltip"
                                                                                            title=""
                                                                                            data-original-title="Sarah Smith">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-truncate">
                                            <ul class="list-unstyled order-list m-b-0 m-b-0">
                                                <li class="team-member team-member-sm"><img class="rounded-circle"
                                                                                            :src="$store.state.app_url + 'assets/img/users/user-7.png'"
                                                                                            alt="user"
                                                                                            data-toggle="tooltip"
                                                                                            title=""
                                                                                            data-original-title="John Deo">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="support-ticket media pb-1 mb-3">
                                <img :src="$store.state.app_url + 'assets/img/users/user-1.png'" class="user-img mr-2"
                                     alt="">
                          ...
                          Deo</span>
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img :src="$store.state.app_url + 'assets/img/users/user-2.png'" class="user-img mr-2"
                                     alt="">
                                <div class="media-body ml-3">
                          ...
                          Smith</span>
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img :src="$store.state.app_url + 'assets/img/users/user-3.png'" class="user-img mr-2"
                                     alt="">
                                <div class="media-body ml-3">
                            ...
                            <div class="support-ticket media pb-1 mb-3">
                                <img :src="$store.state.app_url + 'assets/img/users/user-6.png'" class="user-img mr-2"
                                     alt="">
                                <div class="media-body ml-3">
    ...
    <!--user Dashboard-->
    <div v-if="$store.state.user.is_super_admin == 0">
        <section class="section">
            <div class="row ">
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="card">
