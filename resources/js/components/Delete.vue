        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-body pt-5">
                    <div class="card card-danger">
                        <div class="card-header d-flex justify-content-between">
                            <h4 class="modal-title text-center text-danger" style="width:97%"><i class="fas fa-exclamation-circle fa-2x"></i> Delete Confirmation</h4>
                ...
                <div class="modal-footer d-block pt-0">
                    <button type="button" class="btn btn-danger btn-block" @click="deleteData">Yes</button>
...
export default {
    ...
    methods:{
        async deleteData(){
            const res = await this.callApi("post",this.deletModalInfo.url,this.deletModalInfo.data);
            if (res.status==200) {
                const deletingObj = {
                    ...this.deletModalInfo,
                    url:"",
