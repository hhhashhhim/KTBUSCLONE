...
import OnlineTerminalCancellationRequestsPage from "./pages/booking/OnlineTerminalCancellationRequestsPage.vue";
...
const routes = [
    ...
    {
        path: url + "booking/online-terminals/cancellations",
        component: OnlineTerminalCancellationRequestsPage,
        name: "online-terminal-cancellation-requests",
    },
    {
