            ...
            >
                ...
                <div class="row mx-1 mainRow" v-if="isShowEditDiv">
                    <div class="form-group col-md-6 border py-3">
                        <tr class="seat-img p-0 m-0 " v-for="(record, rowIndex) in dataEdit.seat_map" :key="rowIndex">
                            <td v-for="(col, colIndex) in record" :key="colIndex" :class="col.reserved?'selected-row':''">
                                <img @click="changeEditStatus(rowIndex,colIndex)"
                                     :src="$store.state.app_url+'assets/img/buses/available_seat_img.gif'" alt=""/>
                            </td>
                        </tr>
                    </div>
