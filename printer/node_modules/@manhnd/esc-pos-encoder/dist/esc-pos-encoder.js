...
exports.PrinterWidthEnum = void 0;
...
(function (PrinterWidthEnum) {
    ...
    PrinterWidthEnum[PrinterWidthEnum["_64"] = 64] = "_64";
...
var EscPosEncoder = /** @class */ (function () {
     ...
     * @param options
     */
    function EscPosEncoder(options) {
        this._size = 0;
     ...
     * @param options
     */
    EscPosEncoder.prototype._reset = function (options) {
    ...
    EscPosEncoder.prototype.setPinterType = function (type) {
        switch (type) {
            case PrinterWidthEnum._58: {
                this._printerParam = this._58printerParam;
                break;
            }
            case PrinterWidthEnum._64: {
                this._printerParam = this._64printerParam;
                break;
            }
            case PrinterWidthEnum._80: {
    ...
    Object.defineProperty(EscPosEncoder.prototype, "fullSingleCharLengthPerLine", {
        /**
         *
         * @returns {number}
         */
        get: function () {
            switch (this._printerParam) {
                case this._58printerParam: return 48;
                case this._64printerParam: return 54;
                case this._80printerParam: return 70;
                default: return 48;
            }
        },
        enumerable: false,
     ...
     * @returns {EscPosEncoder}  Return the EscPosEncoder, for easy chaining commands
     */
    EscPosEncoder.prototype.printLineFull = function (char) {
        char = char.slice(0, 1);
        this.line(char.repeat(this.fullSingleCharLengthPerLine));
        return this;
    };
    /**
     *
     * @returns {EscPosEncoder}  Return the EscPosEncoder, for easy chaining commands
     */
    EscPosEncoder.prototype.borderLine = function () {
        this.underline(true);
        this.line(' '.repeat(this.fullSingleCharLengthPerLine));
     ...
     * @returns {EscPosEncoder}  Return the EscPosEncoder, for easy chaining commands
     */
    EscPosEncoder.prototype.width = function (width) {
     ...
     * @returns {EscPosEncoder}  Return the EscPosEncoder, for easy chaining commands
     */
    EscPosEncoder.prototype.height = function (height) {
     ...
     * @returns {EscPosEncoder}  Return the EscPosEncoder, for easy chaining commands
     */
    EscPosEncoder.prototype.printChefDishs = function (_a) {
        var _this = this;
     ...
     *
     */
    EscPosEncoder.prototype.defaultLineHeight = function () {
        this._queue([
            0x1b, 0x32, 0,
        ]);
        return this;
     ...
     * @param data
     */
    EscPosEncoder.prototype.table = function (columns, data) {
        if (this._cursor != 0) {
            this.newline();
        }
        for (var r = 0; r < data.length; r++) {
            ...
            for (var c = 0; c < columns.length; c++) {
                ...
                if (typeof data[r][c] === 'string') {
                    var w = linewrap(columns[c].width, { lineBreak: '\n' });
                    var fragments = w(data[r][c]).split('\n');
                ...
                if (typeof data[r][c] === 'function') {
                    var columnEncoder = new EscPosEncoder(Object.assign({}, this._options, {
                    ...
                    var encoded = columnEncoder.encode();
                    var fragment = [];
                    for (var e = 0; e < encoded.byteLength; e++) {
            ...
            for (var c = 0; c < columns.length; c++) {
                if (lines[c].length < maxLines) {
                    for (var p = lines[c].length; p < maxLines; p++) {
     ...
     *
     */
    EscPosEncoder.prototype.image = function (element, width, height, algorithm, threshold) {
        if (width % 8 !== 0) {
        ...
        var getPixel = function (x, y) { return image.data[((width * y) + x) * 4] > 0 ? 0 : 1; };
     ...
     *
     */
    EscPosEncoder.prototype.bigPriceFormat = function (price) {
        var removeTailPriceStrArr = String(Math.floor(price)).split('').reverse();
        for (var i = 3; i < removeTailPriceStrArr.length; i += 3) {
            console.log(i);
     ...
     */
    EscPosEncoder.prototype.fixLength = function (str1, str2, length) {
        var spaceNum = length - this.getStrWidth(str1) - this.getStrWidth(str2);
...
},{"canvas-dither":7,"canvas-flatten":8,"iconv-lite":28,"linewrap":31}],2:[function(require,module,exports){
'use strict'
...
},{"base64-js":2,"buffer":6,"ieee754":30}],7:[function(require,module,exports){
/**
...
},{"safer-buffer":33}],10:[function(require,module,exports){
"use strict";
...
},{"safer-buffer":33,"string_decoder":5}],13:[function(require,module,exports){
"use strict";
var Buffer = require("safer-buffer").Buffer;
...
},{"safer-buffer":33}],14:[function(require,module,exports){
"use strict";
...
},{"safer-buffer":33}],27:[function(require,module,exports){
"use strict";
...
},{"../encodings":11,"./bom-handling":27,"./streams":29,"safer-buffer":33,"stream":3}],29:[function(require,module,exports){
"use strict";
...
},{"safer-buffer":33}],30:[function(require,module,exports){
